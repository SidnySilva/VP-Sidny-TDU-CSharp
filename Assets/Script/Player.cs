...
public class Player : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            AudioManager.playSound(sound.Win); // Som de vitória
            Vector3 pos = new Vector3(transform.localPosition.x, transform.localPosition.y, transform.localPosition.z); //Capitura as posições atuais do Player
        ...
        {
            AudioManager.playSound(sound.Pop); //Som de Explosão
            Vector3 pos = new Vector3(transform.localPosition.x, transform.localPosition.y, transform.localPosition.z); //Capitura as posições atuais do Player
    ...
    {
        //Congelará o player e trará a tela de Vitória
    ...
    {
       //Congelará o player e trará a tela de Game Over
        rdb.constraints = RigidbodyConstraints.FreezeAll;
        yield return new WaitForSeconds(1);
        c.Panel[2].SetActive(false);
